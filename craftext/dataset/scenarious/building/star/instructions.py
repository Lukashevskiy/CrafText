...
def create_target_state(block_type:BlockType, size:int, cross_type:CrossType):
    target_achievements = BuildStarState(block_type=block_type.value, size=size, radius=10, cross_type=cross_type.value)
