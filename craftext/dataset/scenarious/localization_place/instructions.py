...
def create_target_state(object_inventory_enum, object_to_place, count_to_collect, count_to_stand):
    target_achievements = LocalizaPlacingState(object_inventory_enum.value, object_to_place.value, count_to_collect, count_to_stand)
...
easy = {
    ...
    "INSTRUCTION_PLACE_STONE_TREE_0_4": {
        ...
        "instruction_paraphrases": [
            ...
            "[EASY] Position foliage four blocks under the hardwood.",
            "[EASY] Locate a greens four slots below the log.",
            "[EASY] Set the bush fours steps underneath the trunk."
        ],
